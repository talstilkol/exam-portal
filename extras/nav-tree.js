  ...
  children: [
    {
      ...
      icon: "🛠",
      children: [
        { id: "practice-bank", label: "בנק תרגול", icon: "💪", href: "practice-bank.html", meta: "100 תרגילים" },
    ...
    },
    {
      ...
      children: [
        ...
        { id: "theory-quiz", label: "Theory Quiz", icon: "🧠", href: "theory-quiz.html", meta: "100 כרטיסים" },
        ...
        { id: "data-flow", label: "Data Flow", icon: "📦", href: "data-flow.html", meta: "7 תרחישים" },
